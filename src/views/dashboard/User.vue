            ...
            <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
                ...
                <div class="intro-y box mt-5">
                    <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <button data-carousel="announcement" data-target="prev" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300 mr-2"> <i data-feather="chevron-left" class="w-4 h-4"></i> </button>
                        <button data-carousel="announcement" data-target="next" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300"> <i data-feather="chevron-right" class="w-4 h-4"></i> </button>
                    </div>
                ...
                <div class="intro-y box mt-5">
                    <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <button data-carousel="projects" data-target="prev" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300 mr-2"> <i data-feather="chevron-left" class="w-4 h-4"></i> </button>
                        <button data-carousel="projects" data-target="next" class="tiny-slider-navigator button px-2 border relative flex items-center text-gray-700 dark:text-gray-300"> <i data-feather="chevron-right" class="w-4 h-4"></i> </button>
                    </div>
                ...
                <div class="intro-y box mt-5">
                    <div class="flex items-center px-5 py-3 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <button data-carousel="todays-schedule" data-target="prev" class="tiny-slider-navigator button px-2 border text-white relative flex items-center text-gray-700 dark:text-gray-300 mr-2"> <i data-feather="chevron-left" class="w-4 h-4"></i> </button>
                        <button data-carousel="todays-schedule" data-target="next" class="tiny-slider-navigator button px-2 border text-white relative flex items-center text-gray-700 dark:text-gray-300"> <i data-feather="chevron-right" class="w-4 h-4"></i> </button>
                    </div>
                ...
                <div class="intro-y box mt-5">
                    ...
                    <div class="p-5">
                        <div class="boxed-tabs nav-tabs justify-center flex flex-col sm:flex-row text-gray-700 dark:text-gray-300">
                            <a data-toggle="tab" data-target="#laravel" href="javascript:;" class="w-full sm:w-20 mb-2 sm:mb-0 py-2 rounded-md box dark:bg-dark-5 text-center sm:mx-2 active"> <i data-feather="box" class="w-6 h-6 mb-2 mx-auto"></i> Laravel </a>
                            <a data-toggle="tab" data-target="#symfony" href="javascript:;" class="w-full sm:w-20 mb-2 sm:mb-0 py-2 rounded-md box dark:bg-dark-5 text-center sm:mx-2"> <i data-feather="inbox" class="w-6 h-6 mb-2 mx-auto"></i> Symfony </a>
                            <a data-toggle="tab" data-target="#bootstrap" href="javascript:;" class="w-full sm:w-20 mb-2 sm:mb-0 py-2 rounded-md box dark:bg-dark-5 text-center sm:mx-2"> <i data-feather="activity" class="w-6 h-6 mb-2 mx-auto"></i> Bootstrap </a>
                        </div>
